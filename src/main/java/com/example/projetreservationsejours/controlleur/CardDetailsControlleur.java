...
public class CardDetailsControlleur implements Initializable {
    ...
    public void setCard(Location location) {
        ...
        borderPane.setStyle("-fx-border-color: #534362; -fx-border-radius: 10; -fx-border-width: 2;");
    ...
    public void defineBackground(){
        ...
        boutonConnexion.setStyle("-fx-background-color:#534362FF; -fx-text-fill: #1f6580; -fx-border-radius: 30;-fx-background-radius: 30;-fx-border-color: #1f6580; -fx-arc-width: 30");
        bountonInscription.setStyle("-fx-background-color:#534362FF; -fx-text-fill: #1f6580; -fx-border-radius: 30;-fx-background-radius: 30;-fx-border-color: #1f6580; -fx-arc-width: 30");
        boutonAjoutPanier.setStyle("-fx-background-color: #1f6580; -fx-text-fill:#FFFFFF; -fx-border-radius: 30;-fx-background-radius: 30;-fx-border-color: #FFFFFF; -fx-arc-width: 30");
        addCommentaire.setStyle("-fx-background-color: #FFFFFF; -fx-border-color: #D3D3D3");
        ajouterCommentaire.setStyle("-fx-background-color: #1f6580; -fx-text-fill:#FFFFFF; -fx-border-radius: 30;-fx-background-radius: 30;-fx-border-color: #FFFFFF; -fx-arc-width: 30");
    }
