...
public class PageConnexionControlleur extends Preloader implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        boutonConnexion.setStyle("-fx-background-color: #0d5180; -fx-text-fill:#FFFFFF; -fx-border-radius: 30;-fx-background-radius: 30;-fx-border-color: #FFFFFF; -fx-arc-width: 30");
    }
}
