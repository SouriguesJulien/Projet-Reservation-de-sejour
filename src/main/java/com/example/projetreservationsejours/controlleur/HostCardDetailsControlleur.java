...
public class HostCardDetailsControlleur implements Initializable {
    ...
    public void setBackground(){
        ...
        boutonConnexion.setStyle("-fx-background-color:#FECEA8; -fx-text-fill: #1f6580; -fx-border-radius: 30;-fx-background-radius: 30;-fx-border-color: #1f6580; -fx-arc-width: 30");
        bountonInscription.setStyle("-fx-background-color:#FECEA8; -fx-text-fill: #1f6580; -fx-border-radius: 30;-fx-background-radius: 30;-fx-border-color: #1f6580; -fx-arc-width: 30");
        viewHostMode.setStyle("-fx-background-color: #FFFFFF;-fx-font-size: 18px; -fx-font-family: 'Perpetua';");
        changeViewHostMode.setStyle("-fx-background-color:#FECEA8; -fx-text-fill: #1f6580; -fx-border-radius: 30;-fx-background-radius: 30;-fx-border-color: #1f6580; -fx-arc-width: 30");
    }
}
